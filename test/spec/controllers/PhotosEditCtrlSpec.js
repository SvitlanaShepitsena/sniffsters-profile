...
describe("PhotosEdit Controller Test", function () {
    ...
    }, DataService, scope, $controller, ctrlphotosEdit;
    ...
    it('Should <DO SOMETH.>', function () {
        ...
        ctrlphotosEdit = $controller('PhotosEditCtrl', {
            $scope: scope,
        ...
        expect(1).toBe(1);
        //expect(ctrlphotosEdit.).toBeDefined();
        //expect(ctrlphotosEdit.).toBe();
    });
    ...
    it('Should    when error  ', function () {
        ...
        spyOn(ctrlphotosEdit, 'ShowError');
        scope.$apply();

        expect(2).toBe(2);
        // expect(ctrlphotosEdit.error).toBeDefined();
        // expect(ctrlphotosEdit.ShowError).toHaveBeenCalled();
    });
});
//# sourceMappingURL=PhotosEditCtrlSpec.js.map
