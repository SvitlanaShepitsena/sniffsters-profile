...
describe("TestimonialsEdit Controller Test", function () {
    ...
    }, DataService, scope, $controller, ctrltestimonialsEdit;
    ...
    it('Should <DO SOMETH.>', function () {
        ...
        ctrltestimonialsEdit = $controller('TestimonialsEditCtrl', {
            $scope: scope,
        ...
        expect(1).toBe(1);
        //expect(ctrltestimonialsEdit.).toBeDefined();
        //expect(ctrltestimonialsEdit.).toBe();
    });
    ...
    it('Should    when error  ', function () {
        ...
        spyOn(ctrltestimonialsEdit, 'ShowError');
        scope.$apply();

        expect(2).toBe(2);
        // expect(ctrltestimonialsEdit.error).toBeDefined();
        // expect(ctrltestimonialsEdit.ShowError).toHaveBeenCalled();
    });
});
//# sourceMappingURL=TestimonialsEditCtrlSpec.js.map
