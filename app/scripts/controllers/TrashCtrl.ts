...
class TrashCtrl {
    ...
    constructor(public $scope:ITrashScope, $firebaseSimpleLogin, $modal, public $state:ng.ui.IStateService, public toastr:Toastr, public DataService:DataService) {
        $scope.trash = this;
...
//
    ...
    Delete() {
        this.DataService.deleteForever(this.$scope.home.FireUname, this.selectedUserFire).then(() => {
    ...
    Recover() {
        ...
        this.DataService.recoverConversation(this.$scope.home.FireUname, this.selectedUserFire).then(() => {
            this.corrUsers.splice(this.selectedUserIndex, 1);
            this.corrUsersFire.splice(this.selectedUserIndex, 1);
            this.SetSelectedUser(0);
        })
